...
{ 
    class Effect : Character
    {
        ...
        public Effect(Vector2 position,ICharacterMediator mediator)
            : base("animation", position, 20, mediator)
        {
        ...
        {
            renderer.DrawTexture(name, position, new Rectangle(counter * 40, 0,
                40, 40));
        }
